<template>
    <section class="bg-primary text-white px-6 rounded-xl shadow-md text-sm mb-6 pb-3">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            <div>
                <h1 class="text-xl font-bold">Invoices</h1>
                <p class="text-sm text-white mt-1">Manage all your invoices, track payments, and monitor statuses</p>
            </div>
            <div class="flex flex-wrap gap-3 text-primary-dark">

                <button @click="filterInvoices" class="flex items-center gap-2 border-2 hover:bg-secondary  border-primary text-white  px-4 py-2 rounded-lg font-semibold transition">
                ...
                <button @click="exportInvoices" class="border-2  hover:bg-secondary border-primary flex items-center gap-2 text-white px-4 py-2 rounded-lg font-semibold transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
